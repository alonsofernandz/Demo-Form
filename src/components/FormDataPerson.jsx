      ...
      <div className="row">
        <div className="col">
          <div className="mb-3">
            ...
            <select className="form-select" id="nacionalidad" name="nacionalidad">
          ...
          <div className="mb-3">
            ...
            <select className="form-select" id="departamento" name="departamento">
              <option value="">Seleccione</option>
        ...
        <div className="col-md-6">
          ...
          <div className="mb-3">
            ...
            <input type="text" className="form-control" id="domicilio" name="domicilio" />
          </div>
        </div>
      </div>
    </form>
