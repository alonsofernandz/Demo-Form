          ...
          <div className="col-lg-6 mb-3 mt-3">
            ...
            <div className="row">
                <div className="col-lg-6 mb-3 mt-3">
                    ...
                    <input type="text" className="form-control" placeholder="956236489" name="email"/>
                </div>
                <div className="col-lg-6 mb-3 mt-3">
                    <p className="text-start">Codigo Usuario</p>
                    <input type="password" className="form-control" placeholder="Ingrese código" name="pswd"/>
                </div>
            </div>
